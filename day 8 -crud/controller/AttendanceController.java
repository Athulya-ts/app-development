...
public class AttendanceController {
	...
	@GetMapping("/attendanceShowDetails")
...
//	}
	@PostMapping("/attendanceAddDetails")
	public ResponseEntity<String> create(@RequestBody attendance e)
	{
		serv.saveDetails(e);
		return ResponseEntity.ok("Employee added");
	}
	@GetMapping("/attendanceshowDetailsbyId/{id}")
	public Optional<attendance> fetchID(@PathVariable("id") int id)
	{
		return serv.getDetailss(id);
	}
