...
public class feedback_serv {
	...
	public void addUserFeedback(UserRequest userRequest) {
		...
		var feedback = FeedbackRequest.builder().name(userRequest.getName()).email(userRequest.getEmail()).feedback(userRequest.getFeedback()).build();
